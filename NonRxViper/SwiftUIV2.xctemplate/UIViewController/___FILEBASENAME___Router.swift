...
class ___VARIABLE_sceneName___Router:  ___VARIABLE_sceneName___RouterInterface {
    ...
    static func instantiateController() -> ___VARIABLE_sceneName___Controller {
        ...
        let presenter = ___VARIABLE_sceneName___Presenter(router: router.go)
        let swiftUIView = ___VARIABLE_sceneName___View(presenter.intent, viewModel: presenter.viewModel)
        router.controller = controller
        controller.swiftUIView = swiftUIView
        return controller
    }
